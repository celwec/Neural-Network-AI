...
/*
** #############################################################################
** Testing trained neural network to recognize
** the correct values in a new data set
** #############################################################################
*/
...
function neural(dataset) {
  return nonlin(dot(dataset, syn0));
}

console.log(neural(newDataSet));
